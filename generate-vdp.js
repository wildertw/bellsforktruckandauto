        ...
        <div class="d-flex flex-column align-items-start gap-1" style="min-width:120px;">
          ...
          <div class="d-flex gap-2 align-items-center">
            ...
            <a href="https://www.google.com/maps/place/Bells+Fork+Truck+and+Auto/@35.5641622,-77.367721,15z/data=!3m1!4b1!4m6!3m5!1s0x89aeddacc00176bf:0x2e8db9e8d1d56161!8m2!3d35.5641462!4d-77.349267!16s%2Fg%2F11yxj2p8q_?hl=en&entry=ttu&g_ep=EgoyMDI2MDIyNS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noreferrer" aria-label="Google Business"
               style="display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:5px;background:#4285f4;color:#fff;text-decoration:none;">
              <svg width="17" height="17" fill="currentColor" viewBox="0 0 16 16"><path d="M7.9 4.5V7h5.9c-.3 1.6-1.8 4.5-6.1 4.5-3.7 0-6.7-3-6.7-6.7S4.2 3 7.9 3c1.9 0 3.1.8 3.8 1.5l2.6-2.6C13 1 10.8 0 7.9 0 3.5 0 0 3.5 0 7.9s3.5 7.9 7.9 7.9c4.6 0 7.6-3.2 7.6-7.7 0-.5-.1-1-.2-1.5H7.9z"/></svg>
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <div>
            ...
            <div class="d-flex gap-2">
              ...
              <a href="https://www.google.com/maps/place/Bells+Fork+Truck+and+Auto/@35.5641622,-77.367721,15z/data=!3m1!4b1!4m6!3m5!1s0x89aeddacc00176bf:0x2e8db9e8d1d56161!8m2!3d35.5641462!4d-77.349267!16s%2Fg%2F11yxj2p8q_?hl=en&entry=ttu&g_ep=EgoyMDI2MDIyNS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noreferrer" aria-label="Google Business"
                 style="display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:5px;background:#4285f4;color:#fff;text-decoration:none;">
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M7.9 4.5V7h5.9c-.3 1.6-1.8 4.5-6.1 4.5-3.7 0-6.7-3-6.7-6.7S4.2 3 7.9 3c1.9 0 3.1.8 3.8 1.5l2.6-2.6C13 1 10.8 0 7.9 0 3.5 0 0 3.5 0 7.9s3.5 7.9 7.9 7.9c4.6 0 7.6-3.2 7.6-7.7 0-.5-.1-1-.2-1.5H7.9z"/></svg>
              </a>
            </div>
          </div>
        </div>
