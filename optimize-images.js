...
const _VEHICLE_DIR = path.join(__dirname, 'assets', 'vehicles');
const HERO_DIR = path.join(__dirname, 'assets');
const OUT_DIR = path.join(__dirname, 'assets', 'vehicles', 'optimized');

// Sizes for vehicle images (retained for future use; hero sizes are what run today).
const _VEHICLE_SIZES = [
